...
table(testlogistic4yr$Graduated_within_4_years, predict_4yr_reg)
accuracy <- mean(predict_4yr_reg == testlogistic4yr$Graduated_within_4_years)
...
# Evaluating model accuracy using confusion matrix
table(testlogistic4yr$Graduated_within_4_years, predict_model2)
accuracy <- mean(predict_model2 == testlogistic4yr$Graduated_within_4_years)
print(paste('Accuracy =', accuracy))
