# ===================================================================
# This script computes the Early STEM course (Calc, Physics & Chem) success rates
# It also computes the 1st & 2nd yr retention rates, as well as the 4 & 6 year graduation rates
#Finally, we perform t-tests at the end to determine whether any of these rates from the post-intervention years are significantly different from the pre-intervention years
# ===================================================================
library(plotrix)
library(ggplot2) 
library(gridExtra)
...
df_ENG <- df_ENG[which(df_ENG$Minority==1),]
...
jpeg("minority retention_plots.jpeg",width=700,height=900)
...
yr2_plot <- ggplot(mapping = aes(x = X1, y = X2-10)) +
  ...
  annotate(geom = "text", x = 2010.0, y = 100, label = "= .406", hjust = "left", family="Times") +
...
yr3_plot <- ggplot(mapping = aes(x = X1, y = X2-10)) +
  ...
  annotate(geom = "text", x = 2009.7, y = 100, label = "p", hjust = "left", family="Times", fontface="italic") +
  annotate(geom = "text", x = 2010.0, y = 100, label = "= .339", hjust = "left", family="Times") +
  scale_x_discrete(limits=first_year:last_year) +
  scale_y_continuous(limits= c(0,100), labels = c("10", "35","60","85", "110"))+
...
plot_4yr <- ggplot(mapping = aes(x = X1, y = X2-10)) +
  ...
  annotate(geom = "text", x = 2009.7, y = 100, label = "p", hjust = "left", family="Times", fontface="italic") +
  annotate(geom = "text", x = 2010.0, y = 100, label = "= .030*", hjust = "left", family="Times") +
  scale_x_discrete(limits=first_year:last_year) +
  scale_y_continuous(limits= c(0,100), labels = c("10", "35","60","85", "110"))+
...
plot_6yr <- ggplot(mapping = aes(x = X1, y = X2-10)) +
  ...
  annotate(geom = "text", x = 2009.7, y = 100, label = "p", hjust = "left", family="Times", fontface="italic") +
  annotate(geom = "text", x = 2010.0, y = 100, label = "= .037*", hjust = "left", family="Times") +
  scale_x_discrete(limits=first_year:last_year) +
  scale_y_continuous(limits= c(0,100), labels = c("10", "35","60","85", "110"))+
...
jpeg("minority success_rates.jpeg",width=1000,height=1400)
...
plot_PH131 <- ggplot(mapping = aes(x = X1, y = X2-10)) +
  ...
  annotate(geom = "text", x = 2010.0, y = 100, label = "= .167", hjust = "left", size=5.0, family="Times") +
  scale_x_discrete(limits=first_year:last_year) +
  scale_y_continuous(limits= c(0,100), labels = c("10", "35","60","85", "110"))+
...
plot_PH132 <- ggplot(mapping = aes(x = X1, y = X2-10)) +
  ...
  annotate(geom = "text", x = 2010.0, y = 100, label = "= .500", hjust = "left", size=5.0, family="Times") +
  scale_x_discrete(limits=first_year:last_year) +
  scale_y_continuous(limits= c(0,100), labels = c("10", "35","60","85", "110"))+
...
plot_MA131 <- ggplot(mapping = aes(x = X1, y = X2-10)) +
  ...
  annotate(geom = "text", x = 2009.7, y = 100, label = "p", hjust = "left", size=5.0, family="Times", fontface="italic") +
  annotate(geom = "text", x = 2010.0, y = 100, label = "= .519", hjust = "left", size=5.0, family="Times") +
  scale_x_discrete(limits=first_year:last_year) +
  scale_y_continuous(limits= c(0,100), labels = c("10", "35","60","85", "110"))+
...
plot_MA132 <- ggplot(mapping = aes(x = X1, y = X2-10)) +
  ...
  annotate(geom = "text", x = 2009.7, y = 100, label = "p", hjust = "left", size=5.0, family="Times", fontface="italic") +
  annotate(geom = "text", x = 2010.0, y = 100, label = "= .310", hjust = "left", size=5.0, family="Times") +
  scale_x_discrete(limits=first_year:last_year) +
  scale_y_continuous(limits= c(0,100), labels = c("10", "35","60","85", "110"))+
...
plot_CM131 <- ggplot(mapping = aes(x = X1, y = X2-10)) +
  ...
  annotate(geom = "text", x = 2009.7, y = 100, label = "p", hjust = "left", size=5.0, family="Times", fontface="italic") +
  annotate(geom = "text", x = 2010.0, y = 100, label = "= .766", hjust = "left", size=5.0, family="Times") +
  scale_x_discrete(limits=first_year:last_year) +
  scale_y_continuous(limits= c(0,100), labels = c("10", "35","60","85", "110"))+
