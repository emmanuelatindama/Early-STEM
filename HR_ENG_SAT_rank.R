...
for (i in 1:total_years){
  ...
  #SAT Math scores of majority High Risk students
  df_visual$SATmath_majority[i] <- signif(sum((df_year$Majority)*(df_year$SAT_Math_Convert))/sum(df_year$Majority),3)
  #SAT Math scores of majority High Risk Students who graduate ontime
  ...
  #=================================================================================================================================================================================================
  #SAT Verbal scores of majority High Risk students
  ...
  #SAT Verbal scores of majority High Risk Students who graduate ontime
  ...
  #HS rank of majority High Risk Students who graduate ontime
  ...
  df_visual$na_per[i]<-signif(100*sum(df_year$Native_American)/df_visual$num_students[i], 3)
  ...
  df_visual$per_na_grad[i]<-signif(100*sum((df_year$Native_American)*(df_year$Graduated_within_6_years))/sum(df_year$Native_American), 3)
  ...
  df_visual$per_na_ontime[i]<-signif(100*sum((df_year$Native_American)*(df_year$Graduated_within_4_years))/sum(df_year$Native_American), 3)
  
  
  #SAT Math scores of minority High Risk students
  df_visual$SATmath_minority[i] <- signif(sum((df_year$Minority)*(df_year$SAT_Math_Convert))/sum(df_year$Minority),3)
  #SAT Math scores of minority High Risk Students who graduate ontime
  ...
  #=================================================================================================================================================================================================
  #SAT Verbal scores of minority High Risk students
  ...
  #SAT Verbal scores of minority High Risk Students who graduate ontime
  ...
  #=================================================================================================================================================================================================
  # #HS GPA of minority High Risk students
  # df_visual$GPA_minority[i] <- signif(sum((df_year$Minority)*(df_year$HS_GPA))/sum(df_year$Minority), 3)
  # #HS GPA of minority High Risk Students who graduate ontime
  ...
  df_visual$num_na_who_graduated_ontime[i] <- sum((df_year$Native_American)*(df_year$Graduated_in_4_Yrs))
  df_visual$num_na_who_graduated[i] <- sum((df_year$Native_American)*(df_year$Graduated_in_6_Yrs))
  df_visual$num_na[i] <- sum(df_year$Native_American)
...
png("HR_ENG_SATmath_boxplot.png",width=780,height=880)
min_SAT = ggplot(df_min_SAT, aes(x = Box, y = SAT_Math_Convert, group = Box)) +
  geom_boxplot() + labs(x = "Cohort years",y = "SAT Math Scores", title = "Math SAT (Minority HR ENG)\n") + theme_classic() +
...
maj_SAT = ggplot(df_maj_SAT, aes(x = Box, y = SAT_Math_Convert, group = Box)) +
  geom_boxplot() + labs(x = "Cohort years",y = "SAT Math Scores", title = "Math SAT (Majority HR ENG)\n") + theme_classic() +
  scale_x_continuous(breaks = round(seq(1, 10, by = 1),1), limits= c(0.5,10.5), labels = c("2006","2007","2008","2009","2010","2011","2012","2013","2014","2015"))+
  scale_y_continuous(limits= c(300,800))+
  theme(axis.text.x = element_text(color = "black", size=10, angle=90),
        axis.text.y = element_text(color = "black", size=10),
...
png("HR_ENG_SATverbal_boxplot.png",width=780,height=880)
min_SAT = ggplot(df_min_SAT, aes(x = Box, y = SAT_RW_Convert, group = Box)) +
  geom_boxplot() + labs(x = "Cohort years",y = "SAT Verbal Scores", title = "Verbal SAT (Minority HR ENG)\n") + theme_classic() +
  scale_x_continuous(breaks = round(seq(1, 10, by = 1),1), limits= c(0.5,10.5), labels = c("2006","2007","2008","2009","2010","2011","2012","2013","2014","2015"))+
...
maj_SAT = ggplot(df_maj_SAT, aes(x = Box, y = SAT_RW_Convert, group = Box)) +
  geom_boxplot() + labs(x = "Cohort years",y = "SAT Verbal Scores", title = "Verbal SAT (Majority HR ENG)\n") + theme_classic() +
  scale_x_continuous(breaks = round(seq(1, 10, by = 1),1), limits= c(0.5,10.5), labels = c("2006","2007","2008","2009","2010","2011","2012","2013","2014","2015"))+
  scale_y_continuous(limits= c(250,850))+
  theme(axis.text.x = element_text(color = "black", size=10, angle=90),
        axis.text.y = element_text(color = "black", size=10),
...
png("HR_grad_ENG_SATmath_boxplot.png",width=780,height=880)
min_SAT_ot = ggplot(df_min_SAT_ot, aes(x = Box, y = SAT_Math_Convert, group = Box)) +
  geom_boxplot() + labs(x = "Cohort years",y = "SAT Math Scores", title = "Math SAT (Minority HR ENG grad ot)\n") + theme_classic() +
  scale_x_continuous(breaks = round(seq(1, 10, by = 1),1), limits= c(0.5,10.5), labels = c("2006","2007","2008","2009","2010","2011","2012","2013","2014","2015"))+
  scale_y_continuous(limits= c(250,850))+
  theme(axis.text.x = element_text(color = "black", size=10, angle=90),
        axis.text.y = element_text(color = "black", size=10),
...
maj_SAT_ot = ggplot(df_maj_SAT_ot, aes(x = Box, y = SAT_Math_Convert, group = Box)) +
  geom_boxplot() + labs(x = "Cohort years",y = "SAT Math Scores", title = "Math SAT (Majority HR ENG grad ot)\n") + theme_classic() +
  scale_x_continuous(breaks = round(seq(1, 10, by = 1),1), limits= c(0.5,10.5), labels = c("2006","2007","2008","2009","2010","2011","2012","2013","2014","2015"))+
  scale_y_continuous(limits= c(250,850))+
  theme(axis.text.x = element_text(color = "black", size=10, angle=90),
        axis.text.y = element_text(color = "black", size=10),
...
png("HR_grad_ENG_SATverbal_boxplot.png",width=780,height=880)
min_SAT_ot = ggplot(df_min_SAT_ot, aes(x = Box, y = SAT_RW_Convert, group = Box)) +
  geom_boxplot() + labs(x = "Cohort years",y = "SAT Verbal Scores", title = "Verbal SAT (Minority HR ENG grad ot)\n") + theme_classic() +
  scale_x_continuous(breaks = round(seq(1, 10, by = 1),1), limits= c(0.5,10.5), labels = c("2006","2007","2008","2009","2010","2011","2012","2013","2014","2015"))+
  scale_y_continuous(limits= c(250,850))+
  theme(axis.text.x = element_text(color = "black", size=10, angle=90),
        axis.text.y = element_text(color = "black", size=10),
...
maj_SAT_ot = ggplot(df_maj_SAT_ot, aes(x = Box, y = SAT_RW_Convert, group = Box)) +
  geom_boxplot() + labs(x = "Cohort years",y = "SAT Verbal Scores", title = "Verbal SAT (Majority HR ENG grad ot)\n") + theme_classic() +
  scale_x_continuous(breaks = round(seq(1, 10, by = 1),1), limits= c(0.5,10.5), labels = c("2006","2007","2008","2009","2010","2011","2012","2013","2014","2015"))+
  scale_y_continuous(limits= c(250,850))+
  theme(axis.text.x = element_text(color = "black", size=10, angle=90),
        axis.text.y = element_text(color = "black", size=10),
...
png("HR_ENG_HS_rank.png",width=780,height=560)
min_rank = ggplot(df_min_rank, aes(x = Box, y = HS_Percentile_Rank, group = Box)) +
  geom_boxplot() + labs(x = "Cohort years",y = "High school class rank", title = "HS rank (Minority HR ENG)\n") + theme_classic() +
  scale_x_continuous(breaks = round(seq(1, 10, by = 1),1), limits= c(0.5,10.5), labels = c("2006","2007","2008","2009","2010","2011","2012","2013","2014","2015"))+
...
maj_rank = ggplot(df_maj_rank, aes(x = Box, y = HS_Percentile_Rank, group = Box)) +
  geom_boxplot() + labs(x = "Cohort years",y = "High school class rank", title = "HS rank (Majority HR ENG)\n") + theme_classic() +
  scale_x_continuous(breaks = round(seq(1, 10, by = 1),1), limits= c(0.5,10.5), labels = c("2006","2007","2008","2009","2010","2011","2012","2013","2014","2015"))+
  scale_y_continuous(limits= c(0,100))+
  theme(axis.text.x = element_text(color = "black", size=10, angle=90),
        axis.text.y = element_text(color = "black", size=10),
...
png("HR_ENG_grad_HS_rank.png",width=780,height=880)
min_rank_ot = ggplot(df_min_rank_ot, aes(x = Box, y = HS_Percentile_Rank, group = Box)) +
  geom_boxplot() + labs(x = "Cohort years",y = "High school class rank", title = "HS rank (Minority HR ENG grad ot)\n") + theme_classic() +
  scale_x_continuous(breaks = round(seq(1, 10, by = 1),1), limits= c(0.5,10.5), labels = c("2006","2007","2008","2009","2010","2011","2012","2013","2014","2015"))+
  scale_y_continuous(limits= c(0,100))+
  theme(axis.text.x = element_text(color = "black", size=10, angle=90),
        axis.text.y = element_text(color = "black", size=10),
...
maj_rank_ot = ggplot(df_maj_rank_ot, aes(x = Box, y = HS_Percentile_Rank, group = Box)) +
  geom_boxplot() + labs(x = "Cohort years",y = "High school class rank", title = "HS rank (Majority HR ENG grad ot)\n") + theme_classic() +
  scale_x_continuous(breaks = round(seq(1, 10, by = 1),1), limits= c(0.5,10.5), labels = c("2006","2007","2008","2009","2010","2011","2012","2013","2014","2015"))+
  scale_y_continuous(limits= c(0,100))+
  theme(axis.text.x = element_text(color = "black", size=10, angle=90),
        axis.text.y = element_text(color = "black", size=10),
...
# 7. Proportion of Minority & Majority High Risk students (and graduation proportions) Histogram
png("HR_min_maj_prop.png",width=780,height=880)
...
plot_minority <- ggplot(mapping = aes(x = X1, y = X2)) +
  ...
  labs(x = "", y = "", title ="Prop of min in HR ENG") +
...
plot_majority <- ggplot(mapping = aes(x = X1, y = X2)) +
  ...
  labs(x = "", y = "", title ="Prop of maj in HR") +
  scale_x_discrete(limits=first_year:last_year) +
  scale_y_continuous(limits= c(0,100))+
...
plot_minority_ot <- ggplot(mapping = aes(x = X1, y = X2)) +
  ...
  labs(x = "", y = "", title ="Prop of min in HR grad ot") +
  scale_x_discrete(limits=first_year:last_year) +
  scale_y_continuous(limits= c(0,100))+
...
plot_majority_ot <- ggplot(mapping = aes(x = X1, y = X2)) +
  ...
  labs(x = "", y = "", title ="Prop of maj in HR grad ot") +
  scale_x_discrete(limits=first_year:last_year) +
  scale_y_continuous(limits= c(0,100))+
...
plot_minority_6yr <- ggplot(mapping = aes(x = X1, y = X2)) +
  ...
  labs(x = "", y = "", title ="Prop of min in HR grad 6yr") +
  scale_x_discrete(limits=first_year:last_year) +
  scale_y_continuous(limits= c(0,100))+
...
plot_majority_6yr <- ggplot(mapping = aes(x = X1, y = X2)) +
  ...
  labs(x = "", y = "", title ="Prop of maj in HR grad 6yr ") +
  scale_x_discrete(limits=first_year:last_year) +
  scale_y_continuous(limits= c(0,100))+
...
# Gender based plots
# 8. Proportion of Female & Male High Risk students (and graduation proportions) Histogram
