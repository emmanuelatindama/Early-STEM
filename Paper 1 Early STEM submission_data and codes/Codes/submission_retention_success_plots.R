...
pdf("retention_plots.pdf",width=10,height=10)
...
yr2_plot <- ggplot(mapping = aes(x = X1, y = X2-40)) +
  ...
  annotate(geom = "text", x = 2010.0, y = 65, label = "< .001***", hjust = "left", family="Times") +
...
plot_4yr <- ggplot(mapping = aes(x = X1, y = X2-40)) +
  ...
  annotate(geom = "text", x = 2009.7, y = 65, label = "p", hjust = "left", family="Times", fontface="italic") +
  annotate(geom = "text", x = 2010.0, y = 65, label = "= .011*", hjust = "left", family="Times") +
  scale_x_discrete(limits=first_year:last_year) +
  scale_y_continuous(limits= c(0,65),
                     labels = c("40", "60","80","100"))+
...
pdf("success_rates.pdf",width=12,height=15)
...
plot_PH131 <- ggplot(mapping = aes(x = X1, y = X2-40)) +
  ...
  annotate(geom = "text", x = 2010.0, y = 60, label = "< .001***", hjust = "left", size=5.0, family="Times") +
  scale_x_discrete(limits=first_year:last_year) +
...
plot_PH132 <- ggplot(mapping = aes(x = X1, y = X2-40)) +
  ...
  annotate(geom = "text", x = 2010.0, y = 60, label = "= .237", hjust = "left", size=5.0, family="Times") +
  scale_x_discrete(limits=first_year:last_year) +
  scale_y_continuous(limits= c(0,60),
                     labels = c("40", "60","80","100"))+
...
plot_MA132 <- ggplot(mapping = aes(x = X1, y = X2-40)) +
  ...
  annotate(geom = "text", x = 2009.7, y = 60, label = "p", hjust = "left", size=5.0, family="Times", fontface="italic") +
  annotate(geom = "text", x = 2010.0, y = 60, label = "= .039*", hjust = "left", size=5.0, family="Times") +
  scale_x_discrete(limits=first_year:last_year) +
  scale_y_continuous(limits= c(0,60),
                     labels = c("40", "60","80","100"))+
...
plot_CM132 <- ggplot(mapping = aes(x = X1, y = X2-40)) +
  ...
  annotate(geom = "text", x = 2009.7, y = 60, label = "p", hjust = "left", size=5.0, family="Times", fontface="italic") +
  annotate(geom = "text", x = 2010.0, y = 60, label = "= .783", hjust = "left", size=5.0, family="Times") +
  scale_x_discrete(limits=first_year:last_year) +
  scale_y_continuous(limits= c(0,60),
                     labels = c("40", "60","80","100"))+
...
#satmathdata <- data.frame(rbind(df_control_all$SATMath, df_treatment$SATMath)) # a dataframe for STEM retention after 1yr

df_Math<-data.frame(df,Group=rep(c("control","treatment"),times=c(605,672)))

plt1 <- ggplot(df_Math, aes(y=SATMath, x = Group, group=Group)) + 
  geom_boxplot() + labs(y = "SAT Math Scores") + theme_classic() + 
  scale_x_continuous(limits= c(0.5,2.5), labels = c("" , "Control" , "" , "Treatment" , ""))

plt2 <- ggplot(df_Math, aes(y=SATVerb, x = Group, group=Group)) + 
  geom_boxplot() + labs(y = "SAT Verbal Scores") + theme_classic() + 
  scale_x_continuous(limits= c(0.5,2.5), labels = c("" , "Control" , "" , "Treatment" , ""))

grid.arrange(plt1, plt2, ncol=2,nrow=2) #this creates the 2 col grid
dev.off()
...
# #============================================================================================================================
# # test to check independent t-test assumptions
# #============================================================================================================================
# # Shapiro-Wilk normality test for SAT Math scores
shapiro.test(df_treatment$SATMath)# p = 2e-16
# # Shapiro-Wilk normality test for SAT verbal scores
shapiro.test(df_treatment$SATVerb) # p = 2e-16
...
#============================================================================================================================
# Compute t-test
res1 <- t.test(df_control_all$SATMath, df_treatment$SATMath, alternative = "two.sided", paired = FALSE, var.equal = TRUE)
res1
#SATMath_no <- ro(df_control_all$SATMath)

# printing the p-value
res1$p.value # p-value = 0.12582 not significant

res2 <- t.test(df_control_all$SATVerb, df_treatment$SATVerb, alternative = "two.sided", paired = FALSE, var.equal = TRUE)
res2
# printing the p-value
res2$p.value # p-value = 0.70629 not significant
#SATVerb_no <- ro(df_control_all$SATVerb)


res3 <- t.test(df_control_all$Math_Score, df_treatment$Math_Score, alternative = "two.sided", paired = FALSE, var.equal = TRUE)
res3
# printing the p-value
res3$p.value # p-value = 0.0083513   significant
#ControlMathDiag_no <- ro(df_control_all$Math_Score)
#TreatmentMathDiag_no <- ro(df_treatment$Math_Score)
#res3alt <- t.test(ControlMathDiag_no, TreatmentMathDiag_no, alternative = "two.sided", paired = FALSE, var.equal = TRUE)
#res3alt


res4 <- t.test(df_control_all$Physics_Score, df_treatment$Physics_Score, alternative = "two.sided", paired = FALSE, var.equal = TRUE)
res4
# printing the p-value
res4$p.value # p-value = 0.013524 significant
#ControlPhysicsDiag_no <- ro(df_control_all$Physics_Score)
#TreatmentPhysicsDiag_no <- ro(df_treatment$Physics_Score)
#res4alt <- t.test(ControlPhysicsDiag_no, TreatmentPhysicsDiag_no, alternative = "two.sided", paired = FALSE, var.equal = TRUE)
#res4alt


wil3 = wilcox.test(df_control_all$Math_Score, df_treatment$Math_Score, alternative = "two.sided")
wil3

wil4 = wilcox.test(df_control_all$Physics_Score, df_treatment$Physics_Score, alternative = "two.sided")
wil4

wil1 = wilcox.test(df_control_all$SATMath, df_treatment$SATMath, alternative = "two.sided")
wil1

wil2 = wilcox.test(df_control_all$SATVerb, df_treatment$SATVerb, alternative = "two.sided")
wil2
